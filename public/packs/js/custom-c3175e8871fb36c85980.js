...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('turbolinks:load', function () {
  $(document).ready(function () {
    ...
    // 	let selectedVal = BLOOM_TAXONOMY_VERB[$('#learning_objective_bloom_taxonomy_level_id').find(":selected").val()];
    // 	$('#learning_objective_bloom_taxonomy_verb_id').empty();
    // 	for (var i = 0; i < selectedVal.length; i++) { 
    // 		$('#learning_objective_bloom_taxonomy_verb_id').append(`<option value="${selectedVal[i][0]}">${selectedVal[i][1]}</option>`);
    // 	}
    // });
    // $('#learning_objective_bloom_taxonomy_verb_id').on('change', function() {
    // 	$("#obj_label").empty();
    // 	$("#obj_label").append(`Describe what you want students to ${$('#learning_objective_bloom_taxonomy_verb_id').find(":selected").text()}`);
...
/******/ });
//# sourceMappingURL=custom-c3175e8871fb36c85980.js.map