...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  $('#learning_objective_bloom_taxonomy_level_id').on('change', function () {
    ...
    var selectedVal = BLOOM_TAXONOMY_VERB[$('#learning_objective_bloom_taxonomy_level_id').find(":selected").text()];
    console.log("HEre", selectedVal);

    for (var i = 0; i < selectedVal.length; i++) {
      console.log("ada", selectedVal[i]);
...
/******/ });
//# sourceMappingURL=custom-5728462ecbd19e724ac4.js.map