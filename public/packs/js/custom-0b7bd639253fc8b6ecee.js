...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('turbolinks:load', function () {
  $(document).ready(function () {
    var BLOOM_TAXONOMY_VERB = {
      '1': [[1, 'Remember_1'], [2, 'Remember_2']],
      '2': [[3, 'Understand_1'], [4, 'Understand_2']]
    };
    $('#learning_objective_bloom_taxonomy_level_id').on('change', function () {
      $("#obj_verb").removeClass("d-none");
      $("#obj_description").addClass("d-none");
      $("#obj_map_topics").addClass("d-none");
      var selectedVal = BLOOM_TAXONOMY_VERB[$('#learning_objective_bloom_taxonomy_level_id').find(":selected").val()];
      $('#learning_objective_bloom_taxonomy_verb_id').empty();

      for (var i = 0; i < selectedVal.length; i++) {
        $('#learning_objective_bloom_taxonomy_verb_id').append("<option value=\"".concat(selectedVal[i][0], "\">").concat(selectedVal[i][1], "</option>"));
      }
    });
    $('#learning_objective_bloom_taxonomy_verb_id').on('change', function () {
      $("#obj_label").empty();
      $("#obj_label").append("Describe what you want students to ".concat($('#learning_objective_bloom_taxonomy_verb_id').find(":selected").text()));
      $("#obj_description").removeClass("d-none");
      $("#obj_map_topics").removeClass("d-none");
    });
  });
});
...
/******/ });
//# sourceMappingURL=custom-0b7bd639253fc8b6ecee.js.map